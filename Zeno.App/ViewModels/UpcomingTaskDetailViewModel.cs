...
public partial class UpcomingTaskDetailViewModel : ObservableObject
{
    private readonly TaskItemViewModel  _item;
    private readonly UpcomingViewModel  _parent;
    ...
    public UpcomingTaskDetailViewModel(TaskItemViewModel item, UpcomingViewModel parent)
    {
        _item   = item;
        _parent = parent;
